...
var projectsData = [{
  ...
  img: 'project.jpg',
  title: 'My Portfolio',
  info: 'This is the current website that contains few of my projects. The website was build with React and Gatsby and it was part of an assignment I was given.',
  ...
  img: 'apod.jpg',
  title: 'NASA Apod',
  info: 'This is a simple webpage that calls an API and returns the Astronomy Picture of the Day.',
  info2: 'The webpage is build using React and async requests to NASA API. Everyday it shows a wonderful image so, enjoy the view! ',
  ...
  img: 'yelpy.jpg',
  title: 'Yelpy',
  info: 'A clone of the Yelp website, built entirely with React creating static components, passing information, setting the state and calling the Yelp API.',
  ...
  info: 'This is an application I have done in about an hour, as a form of play. Users can see real images taken from Mars by the three rovers: Curiosity, Opportunity and Spirit.',
  info2: 'This app calls an API from NASA and it was built with Materialize, CSS and API async requests.',
  ...
  img: 'jammming.jpg',
  title: 'Jammming',
  info: 'This is a website that allows users to search the Spotify library, create a custom playlist, then save it to their Spotify account',
  info2: 'The website was build with React, using components, passing state, and requests with the Spotify API.',
